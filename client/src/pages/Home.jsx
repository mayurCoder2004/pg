...
>
  ...
  <p className="text-gray-800 text-2xl bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent animate-pulse">
    Seniors ne banaya, Freshers ke kaam aaya.
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-amber-800 font-semibold text-lg mb-2">
                Cons of NRI / Indian Hostels (Not Recommended)
              </h3>
              <ul className="list-disc list-inside text-amber-700 leading-relaxed space-y-1">
                <li>₹2.3 Lakh fees (~₹18K/month)</li>
                <li>Same boring food, no variety</li>
                <li>Gates close at 9:30 PM (no nightlife)</li>
                <li>Cooking not allowed</li>
                <li>Too many restrictions</li>
                <li>No gym included</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            {filteredPGs.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-500 mb-6 max-w-md mx-auto">
                  We couldn't find any PGs matching your search criteria. Try
        ...
        {!loading && !error && pgs.length > 0 && (
          <div className="mt-12 text-center">
            <div className="inline-flex items-center gap-2 bg-white/70 backdrop-blur-sm rounded-full px-6 py-3 text-sm text-gray-600 border border-gray-200">
              ...
              <span>
                Showing <strong>{filteredPGs.length}</strong> of{" "}
                <strong>{pgs.length}</strong> available PGs
              </span>
            </div>
          </div>
        )}
          ...
          <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-2xl p-8 border border-green-200 shadow-lg">
            <div className="mb-6">
              <h3 className="text-2xl font-bold text-gray-800 mb-3">
                Need Help Finding the Perfect PG?
              </h3>
              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Join our WhatsApp community to get personalized recommendations,
                ask questions, and connect with other students looking for
                accommodation.
              </p>
            </div>
        ...
        {/* Made with love by DSCE Seniors */}
        <div className="text-center pb-8">
          <p className="text-gray-600 text-sm">
            Made with love ❤️ by DSCE Seniors
          </p>
        </div>
      </div>
